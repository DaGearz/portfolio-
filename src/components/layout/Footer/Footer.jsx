...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/toddbwilliams",
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer__content">
          ...
          <div className="footer__brand">
            <Link to="/" className="footer__logo">
              <span className="footer__logo-text">Todd Williams</span>
            </Link>
          ...
          <div className="footer__contact">
            ...
            <div className="footer__contact-info">
              ...
              <Link to="/contact-info" className="footer__contact-link">
                Let's talk →
              </Link>
            </div>
          </div>
        ...
        <div className="footer__bottom">
          <div className="footer__bottom-content">
            <p className="footer__copyright">
              © {currentYear} Todd Williams. All rights reserved.
            </p>
            <div className="footer__bottom-links">
              <a
                href="https://github.com/DaGearz"
                target="_blank"
                rel="noopener noreferrer"
