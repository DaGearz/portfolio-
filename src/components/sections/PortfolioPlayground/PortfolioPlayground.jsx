...
import CartoonMyImage from "../../playground/CartoonMyImage/CartoonMyImage";
  ...
  const playgroundItems = [
    {
      ...
      title: "Tic Tac Toe",
      description:
        "Classic game built with React hooks and state management. Features win detection, game reset, and clean UI.",
      icon: "🎮",
      component: TicTacToe,
    ...
    {
      id: "cartoonmyimage",
      title: "Cartoon My Image",
      description:
        "Interactive image slider that transforms a photo into a cartoon version. Features smooth transitions and localStorage persistence.",
      icon: "🎨",
      component: CartoonMyImage,
    ...
    },
    {
      ...
      title: "Calculator",
      description:
        "Coming soon - A functional calculator with mathematical operations and memory features.",
      icon: "🧮",
      component: null,
    ...
    },
    {
      ...
      description:
        "Coming soon - Real-time weather display with API integration and location services.",
      icon: "🌤️",
      component: null,
            ...
            <Card
              ...
              className={`portfolio-playground__card ${
                ...
                activeComponent === item.id
                  ? "portfolio-playground__card--active"
                  : ""
              }`}
              style={{ animationDelay: `${index * 0.1}s` }}
            >
              <div className="portfolio-playground__card-header">
                <div className="portfolio-playground__card-icon">
                  {item.icon}
                </div>
                <div className="portfolio-playground__card-info">
                  <h3 className="portfolio-playground__card-title">
                    {item.title}
                  </h3>
                  {item.comingSoon && (
                    <span className="portfolio-playground__coming-soon-badge">
                      Coming Soon
                    </span>
                  )}
                </div>
              ...
              {!item.comingSoon && (
                <div className="portfolio-playground__card-actions">
                  <Button
                    variant={
                      activeComponent === item.id ? "outline" : "primary"
                    }
                    size="sm"
