      ...
      <main className={`bColor2 ${styles.Contact}`}>
        <div className={styles.contactContainer}>
          ...
          <p className={styles.description}>
            ...
            connecting with like-minded developers and creatives. Reach out
            through any of the platforms below — let’s build something great
            together.
          </p>
          ...
          <ul className={styles.contactList}>
            <li>
              <Mail size={20} />{" "}
              <a href="mailto:twill003@gmail.com">twill003@gmail.com</a>
            </li>
            <li>
            ...
            <li>
              <Globe size={20} />{" "}
              <a
                href="https://www.toddwilliams.dev"
                target="_blank"
                rel="noreferrer"
              >
                toddwilliams.dev
